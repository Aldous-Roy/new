...
const Signin = () =>{ 
    ...
    const handleSubmit= (e) =>
    {
        ...
        // posting your signin data for authentication
    }

    return (
        <div className='bg-[#222831] sm:w-4/6 md:w-1/2 lg:w-2/6 rounded-xl p-5 w-5/6 '>

            <p className='text-3xl font-bold text-white bg-transparent text-center mb-2'>Sign In</p>
            <hr className='mb-10'/>
            ...
            <form className='grid place-items-center mb-5'>
                ...
                <div className='flex items-center justify-center'> 
                    <button className='bg-[#686D76] p-1 px-2 text-lg hover:scale-105 active:scale-95 transition-all duration-300 rounded-md' onClick={handleSubmit} type='submit'> Sign In</button> 
                </div>

            </form>

            <p className='text-center text-white'>Did'nt have an account?</p>
            <div className='flex items-center justify-center'> 
                <Link to='/signup'>
